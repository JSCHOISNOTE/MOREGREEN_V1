...
<body class="d-flex flex-column min-vh-100">
    ...
    <header class="bg-light1 py-5 mt-auto">
		...
		<div class="row">
			<form method="post" action="/noticeregisterAction.jsp"  enctype="multipart/form-data">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					...
					<tbody>
						<tr>
							<td><input required="required" type="text" class="form-control" placeholder="글 제목" name="n_title" maxlength="50"></td>
						</tr>
						<tr>
							<td><textarea required="required" class="form-control" placeholder="글 내용" name="n_contents" maxlength="2048" style="height: 350px;"></textarea></td>
						</tr>
						<tr>
                        <td><input type="file" class="form-control" name="n_image" value="첨부파일"></td>
                     </tr>
                  </tbody>
               	</table>
               	<!-- 글쓰기 버튼 생성 -->
